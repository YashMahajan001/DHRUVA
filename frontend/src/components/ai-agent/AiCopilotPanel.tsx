...
export const AiCopilotPanel: React.FC<AiCopilotPanelProps> = ({
  ...
  return (
    <div
      id="ai-copilot-panel"
      className="bg-[#161b29] border border-[#3b494b]/30 p-3.5 rounded-xl shadow-lg flex flex-col h-[480px]"
    >
      {/* Copilot Header */}
      <div className="flex items-start justify-between pb-2 mb-2 bg-[#1a1f2d]/60 border border-[#3b494b]/20 p-2.5 rounded">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="flex items-center gap-1.5">
              ...
              <span className="font-mono text-[9px] bg-[#00f0ff]/15 text-[#00f0ff] border border-[#00f0ff]/30 px-1.5 py-0.5 rounded font-semibold">
                DHRUVAA LLM-AERO v3
              </span>
            </div>
      ...
      {/* Advisory Notice */}
      <div className="bg-[#090e1b]/70 border border-[#3b494b]/30 px-2 py-1 rounded text-[9px] font-mono text-[#849495] flex items-center justify-between mb-2">
      ...
      <div className="flex flex-wrap gap-1 mb-2 max-h-16 overflow-y-auto pr-1">
        {sampleQueries.map((query, idx) => (
          <button
            ...
            disabled={isThinking}
            className="font-mono text-[9px] px-2 py-1 rounded bg-[#252a38] hover:bg-[#00f0ff] hover:text-[#00363a] text-[#b9cacb] border border-[#3b494b]/30 transition-colors text-left disabled:opacity-50"
          >
            {query}
          </button>
        ))}
      ...
      <div
        ref={chatScrollRef}
        className="flex-1 overflow-y-auto pr-1 flex flex-col gap-2 font-sans text-xs"
      >
        {messages.map((msg) => {
          ...
          if (isUser) {
            return (
              ...
              >
                <span className="font-mono text-[9px] text-[#00dbe9] block font-semibold">
                  CDR. V. SHASTRI
                </span>
          ...
          return (
            <div
              key={msg.id}
              className="bg-[#252a38]/85 border border-[#3b494b]/40 p-2.5 rounded-lg flex flex-col gap-1.5 shadow-md"
            >
              <div className="flex items-center justify-between text-[#849495] font-mono text-[9px]">
              ...
              {msg.reasoningChain && (
                <div className="text-[11px] leading-relaxed flex flex-col gap-1.5 pt-1">
                  <div>
                    <span className="text-[#849495] uppercase text-[9px] font-mono block font-bold">
                      1. Observation
                    </span>
                  ...
                  <div>
                    ...
                    <p className="text-[#7df4ff] font-mono text-[10px] bg-[#090e1b] p-1.5 rounded border border-[#3b494b]/30">
                  ...
                  <div className="mt-1 pt-1.5 border-t border-[#3b494b]/30 flex justify-between items-center text-[9px] text-[#849495] font-mono">
      ...
      {/* Copilot Input Form */}
      <form onSubmit={handleSubmit} className="mt-2 flex gap-1.5 pt-1">
        <input
          type="text"
          value={inputValue}
        ...
        <button
          ...
          className="bg-[#00f0ff] text-[#00363a] font-mono text-[11px] px-3 py-1.5 rounded font-bold hover:opacity-90 disabled:opacity-40 transition-opacity flex items-center gap-1 cursor-pointer"
        >
          <span>QUERY</span>
